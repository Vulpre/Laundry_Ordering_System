...
<div class="card">
  ...
  <div class="action-buttons" style="margin: 25px 0;">
    <a href="export_csv.php?start=<?= $startDate ?>&end=<?= $endDate ?>" class="btn-export">📥 Export CSV</a>
    <a href="export_excel.php?start=<?= $startDate ?>&end=<?= $endDate ?>" class="btn-export" style="background: #06b6d4;">📊 Export Excel</a>
